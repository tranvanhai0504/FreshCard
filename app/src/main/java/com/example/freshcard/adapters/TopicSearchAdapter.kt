...
class TopicSearchAdapter(var mList: ArrayList<Topic>, val context: Context): RecyclerView.Adapter<TopicSearchAdapter.ViewHolder>() {
    ...
    fun changeBookmarkColor(holder: ViewHolder, color: String){
        val bookmarkDrawable = ContextCompat.getDrawable(context, R.drawable.bookmark_fill)
